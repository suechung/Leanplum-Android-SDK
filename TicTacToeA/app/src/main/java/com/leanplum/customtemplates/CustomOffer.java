...
// Creating a new class for the CustomOffer for PlayStudios
...
public class CustomOffer {
    ...
    private static final String NAME = "CustomOffer";
    private static final String customoffer = "customeroffer";
    ...
    public static void register(Context currentContext) {
        Leanplum.defineAction(
                ...
                new ActionArgs().with(MessageTemplates.Args.TITLE, getApplicationName(currentContext))
                        .with(MessageTemplates.Args.VARIABLE_ID, MessageTemplates.Values.VARIABLE_ID_TEXT)
